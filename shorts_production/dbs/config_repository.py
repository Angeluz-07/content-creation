...
from domain.models import Config, DownloadParams, ShortProductionParams
...
class MongoDownloadParamsRepository(IRepository):
    def __init__(self, client: MongoClient, db_name: str, collection_name: str):
        self._db = client[db_name]
        self._collection = self._db[collection_name]
...
class MongoShortProductionParamsRepository(IRepository):
    def __init__(self, client: MongoClient, db_name: str, collection_name: str):
        self._db = client[db_name]
        self._collection = self._db[collection_name]
