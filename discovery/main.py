...
def get_client(model, collection_name):
    # 2. Conexión a Qdrant
    client = QdrantClient(host="localhost", port=6333)

    # Obtenemos el tamaño del vector automáticamente del modelo
    # all-MiniLM-L6-v2 siempre genera vectores de dimensión 384
...
class VideoSegmentRetriever:
    ...
    def add_segment(self, id, text, metadata):
        """Convierte texto a vector y lo guarda en Qdrant."""
...
client = get_client(model, collection_name)
retriever = VideoSegmentRetriever(client, collection_name, model)
...
# find candidates 
vtt_path = r"C:\Users\rmena\Desktop\dev\content-creation\segment_finder\test.es.vtt"
